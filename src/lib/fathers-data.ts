...
export const fathers: Father[] = [
  {
    ...
    era: "desert",
    years: { ar: "٢٥١ — ٣٥٦ م", en: "251 — 356 AD" },
    monogram: "ⲁ",
    image: antonyIcon,
    works: 8,
    sayings: 126,
  ...
  },
  {
    ...
    era: "theologians",
    years: { ar: "٢٩٦ — ٣٧٣ م", en: "296 — 373 AD" },
    monogram: "ⲑ",
  ...
  },
  {
    ...
    era: "desert",
    years: { ar: "٣٠٠ — ٣٩١ م", en: "300 — 391 AD" },
    monogram: "ⲙ",
    image: macariusIcon,
    works: 6,
    sayings: 141,
  ...
  },
  {
    ...
    era: "patriarchs",
    years: { ar: "٣٧٦ — ٤٤٤ م", en: "376 — 444 AD" },
    monogram: "ⲕ",
    works: 22,
    sayings: 64,
    excerpt: {
  ...
  },
  {
    ...
    era: "desert",
    years: { ar: "٣٤٨ — ٤٦٦ م", en: "348 — 466 AD" },
    monogram: "ϣ",
    works: 11,
    sayings: 73,
    excerpt: {
  ...
  },
  {
    ...
    era: "modern",
    years: { ar: "١٩٠٢ — ١٩٧١ م", en: "1902 — 1971" },
    monogram: "ⲋ",
    works: 5,
    sayings: 58,
    excerpt: {
...
export const libraryItems: LibraryItem[] = [
  {
    ...
    meta: { ar: "٥٧ فصلًا", en: "57 chapters" },
    minutes: 180,
    shelf: "writings",
  },
  {
    ...
    meta: { ar: "٤٠٠ قول", en: "400 sayings" },
    minutes: 240,
    shelf: "writings",
  },
  {
  ...
  },
  {
    ...
    author: { ar: "البابا أثناسيوس الرسولي", en: "St. Athanasius" },
    meta: { ar: "٢٠ رسالة", en: "20 letters" },
    minutes: 120,
    shelf: "homilies",
  },
  {
  ...
  },
  {
    ...
    meta: { ar: "٥٠ تأملًا", en: "50 reflections" },
    minutes: 140,
    shelf: "commentaries",
  },
];
...
export const fatherOfDay = {
  father: fathers[0]!,
  saying: sayings[0]!,
  feast: { ar: "٢٢ طوبة — تذكار نياحته", en: "22 Tobi — his departure" },
};
