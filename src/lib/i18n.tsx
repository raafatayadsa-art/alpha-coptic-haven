...
export const dict: Dict = {
  ...
  "bib.st.week": { ar: "آخر ٧ أيام", en: "Last 7 days" },
  ...
  "km.today.coptic": { ar: "٢٢ أبيب ١٧٤٢", en: "22 Abib 1742" },
  "km.today.greg": { ar: "الأربعاء ٢٩ يوليو", en: "Wednesday, 29 July" },
  ...
  "km.listen.meta": { ar: "تلاوة هادئة · ١٤ دقيقة", en: "Calm recitation · 14 min" },
  ...
  "km.read.ref": { ar: "متى ١٠ : ١٦ - ٢٢", en: "Matthew 10 : 16 - 22" },
  "km.read.minutes": { ar: "٤ دقائق", en: "4 min" },
  ...
  "km.sr.hint": { ar: "مثال: ٢٩ كيهك · إنجيل باكر", en: "e.g. 29 Kiahk · Matins gospel" },
