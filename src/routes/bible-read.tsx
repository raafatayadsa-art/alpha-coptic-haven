    ...
    >
      ...
      {items.map((item, i) => (
        <button
          ...
          type="button"
          onClick={() => onChange(i)}
          className={`press rounded-full px-2 py-1 text-[10.5px] font-semibold transition-colors ${
            i === value
      ...
      >
        ...
        <AlphaOmegaMark
          className={`pointer-events-none absolute inset-x-0 top-48 mx-auto w-[78%] text-copper illum-breathe ${
            night ? "opacity-[0.10]" : "opacity-[0.07]"
          }`}
        />
        ...
        >
          ...
          >
            ...
            <div className="mt-2 flex items-center justify-between gap-2 overflow-x-auto no-scrollbar">
              <ToolTabs
